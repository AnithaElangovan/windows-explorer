 ...
 <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Folder Copy</h4>
      </div>
      
 <!-- *******************new folder creation action *******************************-->
    <form name="filecreation" action="/copyfolder "method="get">
  	<div class="modal-body">
  		Enter the folder name<input type="text" name="folderName"><br><br>
  		Enter the drive name to paste<input type="text" name="driveName"><br><br>
...
<div class="span4 proj-div" data-toggle="modal" data-target="#GSCCModal1"></div>
 ...
 <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;  </button>
        <h4 class="modal-title" id="myModalLabel">File copy</h4>
      </div>
      
 <!-- *******************new folder creation action *******************************-->
    <form name="filecreation" action="/copyfile"method="get">
  	<div class="modal-body">
  		Enter the file name<input type="text" name="fileName"><br><br>
  		Enter the folder name to paste<input type="text" name="folderName"><br><br>
